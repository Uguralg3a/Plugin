...
public class CommandManager extends PaperCommandManager<CommandSender> {
    ...
    public CommandManager() throws Exception {
        super(Plugin.plugin, CommandExecutionCoordinator.simpleCoordinator(), UnaryOperator.identity(), UnaryOperator.identity());
        ...
        if (this.hasCapability(CloudBukkitCapabilities.NATIVE_BRIGADIER)) {
            try {
                ...
                Plugin.plugin.getLogger().warning("Failed to initialize Brigadier support: " + e.getMessage());
            }
        }
